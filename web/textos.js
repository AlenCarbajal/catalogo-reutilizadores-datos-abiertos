...
const TEXTOS = {
  ...
  "catalogo.conteo_filtrado": "(de {total} en total)",
  ...
  "eco.bajada": "Alrededor de datos.gob.ar orbitan Portal Andino, la API Georef y la API Series de Tiempo. Tocá cada una para acercarte y ver lo que la orbita.",
  "eco.ayuda": "Tocá una herramienta para acercarte y tocala de nuevo para ver su enlace. Escape o el botón de arriba vuelven a la vista general.",
  "eco.acercar": "Acercarse a {nombre}",
  "eco.orbita_de": "Lo que orbita a {nombre}",
